...
export declare class CollectionService {
    ...
    private result;
    constructor(userService: UserService, CollectionDbService: CollectionDbService, ArticleDbService: ArticleDbService, PersonalMsgDbService: PersonalMsgDbService, PersonalMsgService: PersonalMsgService);
